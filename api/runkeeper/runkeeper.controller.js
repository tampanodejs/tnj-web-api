...
function get(req, res) {
  ...
  rabbit.request(config.mainExchange, {
    routingKey: 'tnj.runkeeper.get',
    type: 'tnj.runkeeper.get',
    body: data
  }).then(function(final) {
...
function post(req, res) {
  ...
  logger.debug(JSON.stringify(data));
  rabbit.request(config.mainExchange, {
    routingKey: 'tnj.runkeeper.post',
    type: 'tnj.runkeeper.post',
    body: data
  }).then(function(final) {
    logger.debug(JSON.stringify(final.body));
    final.ack();
...
function put(req, res) {
  ...
  logger.debug(JSON.stringify(data));
  rabbit.request(config.mainExchange, {
    routingKey: 'tnj.runkeeper.put',
    type: 'tnj.runkeeper.put',
    body: data
  }).then(function(final) {
    logger.debug(JSON.stringify(final.body));
    final.ack();
...
function destroy(req, res) {
  ...
  logger.debug(JSON.stringify(data));
  rabbit.request(config.mainExchange, {
    routingKey: 'tnj.runkeeper.destroy',
    type: 'tnj.runkeeper.destroy',
    body: data
  }).then(function(final) {
    logger.debug(JSON.stringify(final.body));
    final.ack();
